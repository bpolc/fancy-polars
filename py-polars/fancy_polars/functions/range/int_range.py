...
from fancy_polars._utils.wrap import wrap_expr, wrap_s
from fancy_polars.datatypes import Int64
...
if TYPE_CHECKING:
    ...
    from fancy_polars._typing import IntoExprColumn, PolarsIntegerType
